...
extern int mse_matching_card_name(mse_avl_tree_node_t **ret,
                                  mse_avl_tree_node_t *cards_tree,
                                  char *str,
                                  int is_regex,
                                  int negate,
...
/// abc\\/bcdef -> abc\/bcdef
/// /test123/ -> test123
extern char *mse_escape_regex(char *regex);
