...
extern int mse_init_card_trie_node(mse_card_trie_node_t **node);
extern void mse_free_card_trie_node(mse_card_trie_node_t *node);

/// Inserts a card into the trie, adding nodes where needed
extern int mse_card_trie_insert(mse_card_trie_node_t *root, mse_card_t *card, char *str);
...
extern int mse_card_trie_lookup(mse_card_trie_node_t *trie, char *str, mse_avl_tree_node_t **ret);
...
extern int mse_card_trie_lookup_aprox(mse_card_trie_node_t *trie, char *str, mse_avl_tree_node_t **ret);

extern char *mse_filter_text(char *str);
...
extern int mse_split_card_name(char *name, mse_card_name_parts_t *ret);
extern void mse_free_card_parts(mse_card_name_parts_t *ret);
