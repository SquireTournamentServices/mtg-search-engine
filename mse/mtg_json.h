...
extern size_t __mse_json_write_callback(char *ptr,
                                        size_t size,
                                        size_t nmemb,
                                        void *data);
...
extern void mse_free_colour_index(mse_colour_index_t *index);
...
extern int __mse_handle_all_printings_cards_set(mse_all_printings_cards_t *ret,
        const char *set_code,
        json_t *set_node);

/// Exposed internal method for use within internal testing
/// This method will parse the json cards all of the indexes
extern int __mse_parse_all_printings_cards(mse_all_printings_cards_t *ret, json_t *cards, mse_thread_pool_t *pool);

/// Returns 1 on success, 0 on failure
/// Do not call mse_free_all_printings_cards on fail
extern int mse_get_all_printings_cards(mse_all_printings_cards_t *ret, mse_thread_pool_t *pool);

/// This function will generate all of the indexes for a card, defined in mse_json_indexes.c
extern int __mse_generate_indexes(mse_all_printings_cards_t *ret, mse_thread_pool_t *pool);

/// Frees atomic cards
extern void mse_free_all_printings_cards(mse_all_printings_cards_t *cards);
