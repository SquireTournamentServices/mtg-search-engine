...
extern mse_search_intermediate_t mse_init_search_intermediate_tree(mse_avl_tree_node_t *node, int is_reference);
...
extern int mse_set_union(mse_search_intermediate_t *ret,
...
extern int mse_set_intersection(mse_search_intermediate_t *ret,
                                mse_search_intermediate_t *a,
                                mse_search_intermediate_t *b);
...
extern int mse_set_negate(mse_search_intermediate_t *ret,
                          mse_all_printings_cards_t *cards,
                          mse_search_intermediate_t *a);

/// Frees a search intermediate that has been initialised, call even on init fail.
extern void mse_free_search_intermediate(mse_search_intermediate_t *inter);
...
extern int mse_finalise_search(mse_search_result_t *search_final_res, mse_search_intermediate_t *search_int_res);

/// Takes a search result and resorts it if the sort type has changed
extern void mes_sort_search_results(mse_search_result_t *search_res, mse_search_sort_type_t sort_type);

/// Frees the search result
extern void mse_free_search_results(mse_search_result_t *search_res);
